...
public class Levels {
    ...
    // Table containing the experience required to achieve each level
    ...
    // Returns the experience required to achieve the given level
    ...
    // Returns the level that corresponds to the given experience
